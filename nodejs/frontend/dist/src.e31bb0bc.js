...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"components/Networthinfo.js":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_Component) {
  _inherits(Networthinfo, _Component);
  ...
  function Networthinfo() {
    ...
    _classCallCheck(this, Networthinfo);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Networthinfo)).call.apply(_getPrototypeOf2, [this].concat(args))), _this.state = {
      Networthinfo: {
        userID: 12345,
        factor1: 1.1,
        factor2: 2.2,
    ...
    }, _this.fetchNetworthinfo = function () {
      fetch('http://localhost:3000/account/login').then(function (response) {
        return console.log('response', response);
      });
    }, _temp));
  }

  _createClass(Networthinfo, [{
    ...
    value: function render() {
      var Networthinfo = this.state.Networthinfo;
      return _react.default.createElement("div", null, _react.default.createElement("p", null, " UserID  : ", Networthinfo.userID, "   "), _react.default.createElement("p", null, " factor1 : ", Networthinfo.factor1, "  "), _react.default.createElement("p", null, " factor2 : ", Networthinfo.factor2, "  "), _react.default.createElement("p", null, " factor3 : ", Networthinfo.factor3, "  "), _react.default.createElement("p", null, " netWorth: ", Networthinfo.netWorth, "  "));
    }
  }]);
...
var _Networthinfo = _interopRequireDefault(require("./components/Networthinfo"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _reactDom.render)(_react.default.createElement("div", null, _react.default.createElement("p", null, "Placeholder for Net Worth"), _react.default.createElement(_Networthinfo.default, null)), document.getElementById('net worth'));
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./components/Networthinfo":"components/Networthinfo.js"}],"../../../../../../../usr/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
